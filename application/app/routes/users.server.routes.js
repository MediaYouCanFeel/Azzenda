...
module.exports = function(app) {
    ...
    app.route('/users/:userId').put(users.requiresLogin, users.hasAuthorization, multipartyMiddleware, users.update).get(users.requiresLogin, users.hasAuthorization, users.read);
