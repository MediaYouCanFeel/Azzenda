...
<div class="header high">
    ...
    <h2>
        ...
        Statements: <span class="metric">92.96% <small>(264 / 284)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">81.5% <small>(141 / 173)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">89.09% <small>(49 / 55)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">92.91% <small>(262 / 282)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
...
&nbsp;
      var checkHeaders = function(header) {
        return options.getHeader &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >matchStringOrRegexp(options.getHeader(header.name), header.value);</span>
      };
&nbsp;
      if (!matchHeaders.every(checkHeaders) ||
          !interceptorMatchHeaders.every(checkHeaders)) {
